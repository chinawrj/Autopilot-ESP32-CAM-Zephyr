# Autopilot-ESP32-CAM-Zephyr — Skill & Workflow Feedback
...
- **Detail**: Long-running `west build` sometimes exceeds the default 60s sentinel timeout. Need a way to specify per-command timeout in the sentinel pattern.
